      ...
      <div className="w-full max-w-sm bg-white p-8 rounded-xl shadow-md">
        ...
        <form onSubmit={handleLogin} className="flex flex-col">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`cursor-pointer font-bold text-white bg-gradient-to-r from-[#00FF99] to-[#06412A] rounded-lg py-2 transition hover:opacity-90 active:scale-95 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
